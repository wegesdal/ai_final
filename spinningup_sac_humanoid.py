...
logger_kwargs = dict(output_dir='/home/we/ai-final/humanoid/experiment1', exp_name='SAC')
...
sac(env_fn=env_fn, epochs=200, ac_kwargs=ac_kwargs, logger_kwargs=logger_kwargs)